...
class Colors:
    ...
    def __init__(self):
        ...
        self.pose_palette = np.array([[255, 128, 0], [255, 153, 51], [255, 178, 102], [230, 230, 0], [255, 153, 255],
                                     ...
                                     dtype=np.uint8)
    """
    #2023.09.15 클래스 8개는 초록색, 8개는 빨간색, 나머지 4개는 기존 색상으로 나오게 하기 위한 코드 수정.
    def __init__(self):
        """Initialize colors as hex = matplotlib.colors.TABLEAU_COLORS.values()."""
        hexs = ('#00FF00', '#00FF00', '#00FF00', '#00FF00', '#00FF00', '#00FF00', '#00FF00', '#00FF00', # 초록색 8개
                '#FF0000', '#FF0000', '#FF0000', '#FF0000', '#FF0000', '#FF0000', '#FF0000', '#FF0000', # 빨간색 8개
                '520085', 'CB38FF', 'FF95C8', 'FF37C7')  # 기존의 다른 색상들
        self.palette = [self.hex2rgb(c) for c in hexs]
        self.n = len(self.palette)
        self.pose_palette = np.array([[255, 128, 0], [255, 153, 51], [255, 178, 102], [230, 230, 0], [255, 153, 255],
                                      [153, 204, 255], [255, 102, 255], [255, 51, 255], [102, 178, 255], [51, 153, 255],
                                      [255, 153, 153], [255, 102, 102], [255, 51, 51], [153, 255, 153], [102, 255, 102],
...
def plot_labels(boxes, cls, names=(), save_dir=Path(''), on_plot=None):
    ...
    if 0 < len(names) < 30:
        ...
        ax[0].set_xticklabels(list(names.values()), rotation=90, fontsize=8)
    else:
